        ...
        <div className="py-8 px-8 bg-[#f3f4ff] w-full">
            <div className='grid grid-cols-2 justify-items-center md:justify-items-stretch md:flex md:justify-between items-center'>
                ...
                <div className='grid grid-cols-2 gap-4 justify-items-end w-fit'>
                    <div onClick={toggleSortOrder} className='border-2 border-[#4d44b5] text-[#4d44b5] rounded-3xl w-fit flex items-center gap-2 px-4 py-2 hover:bg-[#4d44b5] hover:text-white transition-colors duration-200 cursor-pointer'>
                        <ChevronDownIcon className="size-5" />
                        <span>{sortOrder === 'newest' ? 'Newest' : 'Oldest'}</span>
                    </div>
                    <div className='bg-[#4d44b5] text-white px-4 py-2 rounded-3xl w-fit flex items-center gap-2 hover:bg-[#3b358f] transition-colors duration-200 cursor-pointer'>
